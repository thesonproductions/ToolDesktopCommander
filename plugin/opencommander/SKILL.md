---
name: opencommander-coding-workflow
description: Use whenever working on code, tests, builds or long-running jobs through the OpenCommander MCP server — enforces inspect → checkpoint → minimal edit → verify → report, background jobs for slow work, and resumable task state.
---

# OpenCommander coding workflow
